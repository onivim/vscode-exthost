...
import { IRPCProtocol, ProxyIdentifier, getStringIdentifierForProxy, getNumberIdentifierForProxy } from 'vs/workbench/services/extensions/node/proxyIdentifier';
...
export class JsonRPCProtocol extends Disposable implements IRPCProtocol {
	...
	private _receiveRequest( req: number, rpc: string, method: string, args: any[], usesCancellationToken: boolean): void {
